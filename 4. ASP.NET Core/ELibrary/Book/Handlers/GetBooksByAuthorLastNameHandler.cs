...
{
    public class GetBooksByAuthorLastNameHandler
    {

        private readonly BookContext _context;

        public GetBooksByAuthorLastNameHandler(BookContext context)
        {
            _context = context;
        }

        public List<Model.Book> Handle(string lastName)
        {
